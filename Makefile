...
# my.domain/registry-operator-bundle:$VERSION and my.domain/registry-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/registry-operator/registry-operator
...
IMG ?= ghcr.io/registry-operator/controller:latest
...
.PHONY: envtest
envtest: $(ENVTEST) ## Download envtest-setup locally.
$(ENVTEST): $(LOCALBIN)
	test -s $(LOCALBIN)/setup-envtest || GOBIN=$(LOCALBIN) go install sigs.k8s.io/controller-runtime/tools/setup-envtest@latest

.PHONY: operator-sdk
operator-sdk: ## Download operator-sdk locally. If wrong version is installed, it will be overwritten.
